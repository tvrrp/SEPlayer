...
extension BoxParser {
    public struct EsdsData: Format.InitializationData {
        public let mimeType: MimeTypes?
        ...
        public func buildCMFormatDescription(using format: Format) throws -> CMFormatDescription {
            formatDescription
        }
    ...
    public struct ESDescriptor {
        public let codecInfo: CMAudioFormatDescription

        public init(esdt payload: Data) throws {
