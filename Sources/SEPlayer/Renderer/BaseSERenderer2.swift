...
class BaseSERenderer2: SERenderer {
    ...
    final func getStream() -> SampleStream2? { sampleStream }
    ...
    func isReady() -> Bool { fatalError() }
    func isEnded() -> Bool { fatalError() }
    ...
    final func readSource(to buffer: DecoderInputBuffer, readFlags: ReadFlags = .init()) throws -> SampleStreamReadResult2 {
