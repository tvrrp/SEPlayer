...
public enum Queues {
    ...
    static let sharedVideoDecodeQueue: Queue = SignalQueue(name: "com.seplayer.sharedDecodeQueue.shared", qos: .userInitiated)
    static let sharedAudioDecodeQueue: Queue = SignalQueue(name: "com.seplayer.sharedDecodeQueue.shared", qos: .userInitiated)
