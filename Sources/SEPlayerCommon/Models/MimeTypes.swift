...
public enum MimeTypes: String, Sendable {
    // MARK: - Video
    ...
    case applicationSEPlayerCues = "application/x-seplayer-cues"
...
public extension Optional where Wrapped == MimeTypes {
