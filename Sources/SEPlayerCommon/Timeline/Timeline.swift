...
public protocol Timeline: Sendable, AnyObject {
...
public extension Timeline {
    ...
    func _lastWindowIndex(shuffleModeEnabled: Bool) -> Int? {
        isEmpty ? nil : windowCount() - 1
    }
    ...
    func _firstWindowIndex(shuffleModeEnabled: Bool) -> Int? {
        isEmpty ? nil : 0
    }
    ...
    func defaultPeriodById(_ id: AnyHashable, period: Period) -> Period {
