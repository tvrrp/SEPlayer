...
public enum Util {
    ...
    @inline(__always)
    public static func binarySearchCeil<T: Comparable>(array: [T], value: T, inclusive: Bool, stayInBounds: Bool) -> Int {
    ...
    // TODO: make indexUset as nil
    @inline(__always)
    public static func binarySearch<T: Comparable>(array: [T], value: T, inclusive: Bool, stayInBounds: Bool) -> Int {
        var index = array.binarySearch(value: value)
    ...
    @inline(__always)
    public static func scaleLargeTimestampsInPlace(_ timestamps: inout [Int64], multiplier: Int64, divisor: Int64) {
        for index in 0..<timestamps.count {
            timestamps[index] = scaleLargeTimestamp(timestamps[index], multiplier: multiplier, divisor: divisor)
        }
    }

    @inline(__always)
    public static func scaleLargeTimestamp(_ timestamp: Int64, multiplier: Int64, divisor: Int64) -> Int64 {
        scaleLargeValue(timestamp, multiplier: multiplier, divisor: divisor, roundingMode: .down)
    }

    @inline(__always)
    public static func scaleLargeValue(
        _ value: Int64,
        multiplier: Int64,
        divisor: Int64,
